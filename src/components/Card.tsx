...
const Card: React.FC<{
  ...
  return (
    <div className=" rounded-md flex flex-col items-center justify-between text-center shadow-md p-8 hover:shadow-lg dark:hover:transiton dark:bg-slate-900 dark:text-white dark:hover:bg-slate-600 dark:hover:transition bg-white">
